...
<?php
$data=$_GET['query'];
$querycoupon="select * from store where name LIKE '%$data%'";
$storeresult = mysqli_query($conn, $querycoupon);
?>
...
<section class="top-store-category-sec sec-padding">
        <div class="container">
                <div class="content-entry">
                    ...
                    <div class="sec-title">
                        <h3>You Search For store '<?php echo $data?>'</h3>
                    </div>
                        <div class="product-tiles">
                            <div class="row">

                            <?php while($row=mysqli_fetch_array($storeresult))
                    {
        ?>
