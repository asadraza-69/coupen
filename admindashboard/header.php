...
<!-- Mirrored from tixia.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 12:01:18 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>CrazzyCoupon - Admin Dashboard </title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/crazzyicon.png">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="home.php" class="brand-logo">
				<img class="logo-abbr" width="58" height="46" src="images/crazzyicon.png" >
				
				<p class="brand-title" style="color:#ff7a01" >Crazzy-Coupon</p>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="categories.php" class="ai-icon" aria-expanded="false">
							<i class="fa fa-home"></i>
							<span class="nav-text">Category</span>
						</a>
					</li>
					<li><a href="stores.php" class="ai-icon" aria-expanded="false">
							<i class="fa fa-shopping-cart"></i>
							<span class="nav-text">Stores</span>
						</a>
					</li>
					<li><a href="coupons.php" class="ai-icon" aria-expanded="false">
							<i class="flaticon-381-id-card"></i>
							<span class="nav-text">Coupons</span>
						</a>
					</li>
                    <li><a href="coupontype.php" class="ai-icon" aria-expanded="false">
							<i class="fa fa-bookmark"></i>
							<span class="nav-text">Coupon Type</span>
						</a>
					</li>
                    
                    <li><a href="subscribers.php" class="ai-icon" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<!--li><a href="sliders.php">Slider</a></li-->
